  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        subtle: "0 1px 2px 0 oklch(0.13 0.02 50 / 0.4), 0 4px 16px -4px oklch(0.13 0.02 50 / 0.35)",
        elevated:
          "0 2px 4px 0 oklch(0.13 0.02 50 / 0.5), 0 16px 48px -12px oklch(0.13 0.02 50 / 0.55)",
        ember: "0 8px 32px -12px oklch(0.74 0.16 65 / 0.35)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
